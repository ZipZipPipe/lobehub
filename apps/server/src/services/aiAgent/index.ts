...
export class AiAgentService {
  ...
  private async execAgentWithReservation(
    ...
    if (params.disableTools) {
      ...
      const historyMediaAvailability = getMediaAvailabilityFromMessages(
      ...
      // natively supported, remove only its multimodal fallback API so models
      // such as Kimi cannot redundantly choose a tool over supplied media blocks.
