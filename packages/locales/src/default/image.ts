export default {
  ...
  'config.background.options.auto': 'Auto',
  ...
  'config.moderation.label': 'Content Moderation',
  'config.moderation.options.auto': 'Standard',
  'config.moderation.options.low': 'Less Restrictive',
  'config.outputCompression.label': 'Output Compression',
  'config.outputFormat.label': 'Output Format',
  'config.outputFormat.options.jpeg': 'JPEG',
  'config.outputFormat.options.png': 'PNG',
  'config.outputFormat.options.webp': 'WebP',
  ...
  'config.quality.options.max': 'Maximum',
  ...
  'config.size.custom.cancel': 'Cancel custom size',
  'config.size.custom.confirm': 'Use custom size',
  'config.size.custom.error':
    'Width and height must be multiples of {{step}}, use a 1:3–3:1 ratio, stay within {{minPixels}}–{{maxPixels}} total pixels, and not exceed {{maxEdge}} px per edge.',
  'config.size.custom.label': 'Custom Size',
