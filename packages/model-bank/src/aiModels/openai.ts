...
export const openaiChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    description:
      'GPT-5.6 Sol is the flagship GPT-5.6 model for frontier capability and complex professional work.',
  ...
  },
  {
    ...
    contextWindowTokens: 1_050_000,
    description:
      'GPT-5.6 Terra balances strong GPT-5.6 capability with lower cost for everyday production use.',
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description:
      'GPT-5.6 Luna is the efficient GPT-5.6 model for high-volume workloads.',
