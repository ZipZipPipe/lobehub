...
- Type: Optional
- Description: Set to `1` to disable all new user registration while keeping existing email/password and SSO sign-in available. Email/password, SSO, magic-link, and OTP flows cannot create new users when enabled.
- Default: `0`
- Example: `1`
